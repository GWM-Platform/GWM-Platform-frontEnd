...
const DeleteConfirmationModal = ({ show, setShowModal, Asset, chargeAssets }) => {
    ...
    const deleteAsset = async () => {
        ...
        const url = `${process.env.REACT_APP_APIURL}/Assets/${Asset.id}`;
        ...
        <Modal className="deleteModal" size="sm" show={show} onHide={handleClose}>
            <Modal.Body className="body">
                <div className={!DeleteFetch.fetched && !DeleteFetch.fetching ? "show" : "hidden"}>
                    ...
                    <h2 className="subTitle">{t("You are about to delete the Asset")}{" \""}{Asset.name}{"\""}</h2>
                ...
                <div className={DeleteFetch.fetched && !DeleteFetch.fetching ? "show" : "hidden"}>
                    {
                        DeleteFetch.valid ?
                            <>
                                ...
                                <h2 className="subTitle mt-4">{t("The Asset")}{" \""}{Asset.name}{"\" "}{t("has been removed succesfully")}</h2>
                            </>
                            :
                            <>
                                <div className="descriptionIconContainer red mx-auto">
            ...
            <Modal.Footer className="footer justify-content-center">
                {
                    DeleteFetch.fetched ?
                        ...
                        <>
                            ...
                            <Button variant="outline-danger" onClick={() => { deleteAsset() }}>
