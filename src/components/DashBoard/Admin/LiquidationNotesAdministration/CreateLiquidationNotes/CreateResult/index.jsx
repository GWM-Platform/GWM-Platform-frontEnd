...
const CreateResult = ({ CreateRequest, setAction, chargeNotes, Notes, Action }) => {
                    ...
                    <div className="d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '400px' }}>
                        {
                            CreateRequest.valid ?
                                <>
                                    ...
                                    <h2 className="text-center mb-4">{t("Liquidation option created successfully")}</h2>
                                </>
                                :
                                <>
                                    <div className="d-flex justify-content-center align-items-center mb-4">
                                    ...
                                    <h2 className="text-center mb-4">{t("Failed to create liquidation option")}</h2>
                                </>
                        }
                        <Button
