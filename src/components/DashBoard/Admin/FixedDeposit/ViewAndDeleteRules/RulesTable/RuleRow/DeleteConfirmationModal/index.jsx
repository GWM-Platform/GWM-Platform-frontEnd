...
const DeleteConfirmationModal = ({ show, setShowModal, rule, FixedDeposit ,getFixedDepositPlans}) => {
    ...
    const deleteRule = () => {
        ...
        let FixedDepositEdited = { ...FixedDeposit }
        delete FixedDepositEdited.interest[rule]
