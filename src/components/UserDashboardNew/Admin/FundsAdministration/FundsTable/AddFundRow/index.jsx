    ...
    return (
        <>
            <tr className="fundRow addFund">
                ...
                <td className="cellWithoudPadding">
                    <Form.Control
                    ...
                    <Form.Select id="typeId" required className="h-100" onChange={handleChange}>
                        {
                            AssetTypes.map((Asset, key) => {
                                return <option value={Asset.id} selected={newFund.typeId === Asset.Id}>{Asset.name}</option>
                            })
                        }
                    </Form.Select>
                </td>
                ...
                <td className="verticalCenter" >
                    <div className="h-100 d-flex align-items-center justify-content-around">
                        <div className="iconContainer green" onClick={() => console.log(newFund)}>
