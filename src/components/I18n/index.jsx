    ...
    resources: {
      en: {
        translation: {
          ...
          "FIXED_DEPOSIT_CREATE": "Investment in fixed deposit #{{fixedDeposit}}",
          "FIXED_DEPOSIT_CLOSE": "Close of fixed deposit #{{fixedDeposit}}",
          ...
          "Fixed deposit Start date":"Start data"
        }
      },
      es: {
        translation: {
          ...
          "Fixed Deposits history": "Historial de plazos fijos",
          "Actual Profit": "Ganancia actual",
          "Profit at the end": "Ganancia al final",
          "Creation Date": "Fecha de creación",
          "Start Date": "Fecha de inicio",
          "End Date": "Fecha de finalización",
          "Fixed deposit": "Plazo fijo",
          "time deposit": "plazos fijo",
          "There is no fixed deposit created": "No hay un plazo fijo creado",
          "Create": "Crear",
          "Fixed deposit rules administration": "Administración de reglas de plazo fijo",
          "Active fixed deposits": "Plazos fijos activos",
          ...
          "Fixed deposit Start date": "Desde",
          "Due date": "Hasta",
